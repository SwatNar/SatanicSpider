...
public class EntityFactory
{
	...
	public static Entity createPlayer(Vec2 pos, float ang)//Body tmp)
	{
		...
		Entity phys_ent = PhysicsWorld.getEntity(player_ent.getUuid());
	...
	public static Entity createTree(Vec2 pos, float ang)//Body tmp)
	{
		...
		Entity phys_ent = PhysicsWorld.getEntity(tree_ent.getUuid());
	...
	public static Entity createHouse(Vec2 pos, float ang)//Body tmp)
	{
	...
	public static Entity createPlayer(Vec2 pos, float ang, UUID id)//Body tmp)
	{
