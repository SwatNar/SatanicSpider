package com.SatanicSpider.SpiderEngine;

import com.SatanicSpider.*;
...
import com.SatanicSpider.Scriptoholic.Scriptoholic2;
...
//TODO
public class SampleEngineImpl extends SimpleApplication implements Engine
{

    boolean run = true;
    static SampleEngineImpl app;

    
    GUIConsole console;
    public static void main(String[] args) {
        
        app = new SampleEngineImpl();
    ...
    public void initConsole(GUIConsole console)
    {
        ...
        Scriptoholic2.parse("com.SatanicSpider",console);
        //Scriptoholic2.parse("org.jbox2d", console);
