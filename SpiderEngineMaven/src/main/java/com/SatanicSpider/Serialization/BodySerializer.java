 ...
 * @author bryant
 */
public class BodySerializer implements JsonSerializer<Body>,JsonDeserializer<Body>
{

	public JsonElement serialize(final Body Src, final Type typeOfSrc, final JsonSerializationContext context)
	{
	...
	public Body deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
	{
		...
		try
		{
			...
			Body b = PhysicsManager.JSONifier.j2b2Body(PhysicsManager.PhysWorld, new JSONObject(jsonS));
		}
		catch(Exception ex)
		{
			System.err.println("Unknown Exception");
